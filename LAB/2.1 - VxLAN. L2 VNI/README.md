...
Так же для Arista дефолтным является поведение передачи префиксов с неизвестными RT (Spine передает по eBGP все префиксы для VFR которых нет у него локально) 
