...
Anycast GW - ip(mac) адрес шлюза будет единый для всех LEAF членах данного сервиса, для конечных хостов это будет значить, что при миграции на другой LEAF у них не изменятся атрибуты шлюза.
...
Видим локальные mac и mac+ip маршруты локального хоста, а так же mac и mac+ip маршруты хоста за DC1-SW3-LEAF3
